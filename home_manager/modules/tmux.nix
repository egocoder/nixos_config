{ pkgs, ... }: {
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind -n M-r source-file ~/.config/tmux.conf \; display "Reloaded!"
      ...
      bind -n M-o new-window -c ~/para "nvim -c 'Telescope find_files' 'O Inbox/todolist.md'"
    ...
    tmuxPlugins.gruvbox
    # {
    #   plugin = tmuxPlugins.ressurect;
    #   extraConfig = "set -g @ressurect-strategt-nvim 'session'";
    # }
    # {
